...
PasskeysRails.config do |c|
  ...
  #
  # c.auth_token_secret = '31ce5ef38c63a6a12f687c1de37dc8334e56bb1dce9fd7917dbf7427355abb7b06f12fde6f6b9360978095b54035351422bad91b0109a1d442d2b42c9347d9c7'
  ...
  c.wa_origin = Rails.application.credentials.dig(:webauthn, :origin) || (Rails.env.production? ? "https://job-journal.fly.dev" : "http://localhost:3000")

  # Relying Party name for display purposes
  c.wa_relying_party_name = "JobJournal"
  
  # Default class for passkey authentication
  c.default_class = "User"
